...
public class AudioPlayerActivity extends AppCompatActivity {
    ...
    private AppCompatTextView songName, startTime, songTime;
    private SeekBar songPrgs;
    private static int oTime = 0;
    private static int sTime = 0;
    private static int eTime = 0;
    private static final int fTime = 5000;
    private static final int bTime = 5000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AudioPlayerActivity.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
